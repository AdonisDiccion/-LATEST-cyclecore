...
const Footer = () => {
  return (
    <div className=" border-t-4 font-varela max-w-screen-2xl mx-auto py-10 px-4 grid lg:grid-cols-3 gap-8 text-gray-700 delay-500 mt-12">
      <div>
        <a href="#">
          <img
            data-aos="fade-right"
        ...
        >
          <FaFacebookSquare
            size={30}
            className="hover:text-gray-600 hover:scale-110 cursor-pointer"
          />
          <FaInstagramSquare
            size={30}
            className="hover:text-gray-600 hover:scale-110 cursor-pointer"
      ...
      <div className="lg:col-span-2 flex justify-between mt-16">
        <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
          <h6 className="font-varela font-bold text-gray-700">Solutions</h6>
          <ul>
        ...
        <div data-aos="fade-down" data-aos-duration="1000" data-aos-delay="300">
          <h6 className="font-varela font-bold text-gray-700">Products</h6>
          <ul>
        ...
        <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500">
          <h6 className="font-varela font-bold text-gray-700">Quick Links</h6>
          <ul>
