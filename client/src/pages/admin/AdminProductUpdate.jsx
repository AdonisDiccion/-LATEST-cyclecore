        ...
        <div className="font-pop mr-24 mt-5 w-1/2">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex justify-between">
              <div className="pt-5 flex">
                <button
                  type="submit"
                  className="flex uppercase shadow bg-gray-700 hover:bg-blue-900 focus:shadow-outline focus:outline-none text-white text-xs py-2 px-4 rounded"
                >
                  Submit
                </button>
              </div>
          ...
          <div className="pt-5 flex">
            <button
              ...
              className="flex uppercase shadow bg-red-700 hover:bg-blue-900 focus:shadow-outline focus:outline-none text-white text-xs py-2 px-4 rounded"
            >
              Delete
            </button>
          </div>
