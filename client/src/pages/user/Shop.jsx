  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:flex m-20 md:mt-24 ">
        <div>
          <h1 className=" mx-auto mb-10 text-center font-bold font-varela">
          ...
          <h1 className=" mx-auto mb-10 text-center pt-10 font-bold font-varela">
            Filter by Sub-Categories
          </h1>
          {subcategories?.map((s) => (
            <div key={s._id}>
              <Checkbox onChange={(e) => handleSubCheck(e.target.checked, s._id)}>
                {s.name}
              </Checkbox>
            </div>
          ))}
          ...
          {brands?.map((b) => (
            <div key={b._id}>
              <Checkbox onChange={(e) => handleBrandCheck(e.target.checked, b._id)}>
                {b.name}
              </Checkbox>
            </div>
          ))}
