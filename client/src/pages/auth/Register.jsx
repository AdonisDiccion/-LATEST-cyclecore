...
import regLogo from "../../assets/regLogo.jpg";
...
const Register = () => {
  ...
  // dialogs for terms and conditions
      ...
      <section className="bg-gray-50 min-h-screen flex items-center justify-center">
        ...
        <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-6xl p-5">
          ...
          <div className="md:w-1/2 p-5">
            ...
            <h2 className="text-[#002D74] font-bold text-2xl font-varela">Register</h2>
            <p className="text-[#002D74] text-sm my-4 font-varela">
              If you are already a member, easily login{" "}
              <a href="#" className="underline font-se">
                Here
              </a>
            </p>
